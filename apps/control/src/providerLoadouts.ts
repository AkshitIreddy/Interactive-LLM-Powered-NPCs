...
export const ROUTE_OPTIONS: Record<ProviderRole, RouteProviderOption[]> = {
  ...
  lipSync: [
    offLipSync,
    {
      ...
      note: "A desired candidate can be saved now. It cannot run or download until a signed qualified pack exists.",
      models: [
        {
          id: "nvidia-ar-lipsync",
          name: "NVIDIA AR SDK LipSync · conditional",
          selectable: false,
        },
        {
          id: "musetalk",
          name: "MuseTalk 1.5 · experimental",
          selectable: false,
        },
        {
          id: "mouth-warp",
          name: "Tracked viseme warp · baseline",
          selectable: false,
        },
        { id: "ditto", name: "Ditto 0.4 · deferred", selectable: false },
        {
          id: "latentsync",
          name: "LatentSync · offline only",
          selectable: false,
        },
      ],
    },
