...
export const ROUTE_OPTIONS: Record<ProviderRole, RouteProviderOption[]> = {
  llm: [
    ...
    },
    {
      ...
      models: [{ id: "gemini-3.1-flash-lite", name: "Gemini 3.1 Flash-Lite" }],
    },
    {
      id: "anthropic",
      name: "Anthropic",
    ...
    },
    {
      ...
      models: [
        ...
        {
          id: "qwen/qwen3.6-27b",
          name: "Qwen 3.6 27B · non-reasoning profile",
          note: "Uses the exact qualified Groq non-reasoning request profile so the response budget produces dialogue.",
        },
      ],
    },
    {
      ...
      execution: "Cloud",
      privacy: "Conversation text and selected context leave this PC",
      egress: "Text → Mistral AI",
      cost: "Rate-limited free mode or metered usage",
      models: [
        { id: "ministral-8b-2512", name: "Ministral 8B 25.12" },
        { id: "ministral-3b-2512", name: "Ministral 3B 25.12" },
      ],
    },
    {
      id: "openrouter",
      ...
      execution: "Cloud",
      privacy: "Conversation text and selected context leave this PC",
      egress: "Text → OpenRouter and the selected model host",
      cost: "Free route; availability and rate limits can change",
      note: "The selected free model is pinned to the provider that passed qualification. If it leaves OpenRouter's catalog, choose another qualified route.",
      models: [
        {
          id: "liquid/lfm-2.5-2.6b:free",
          name: "Liquid LFM 2.5 2.6B · free",
          note: "Fallback routing is disabled so OpenRouter cannot silently substitute a different model.",
        },
      ],
    },
    {
  ...
  tts: [
    ...
    },
    {
      ...
      note: "Sonic 3.6 with the public Greg stock voice passed the native streaming, PCM, timing, cancellation, and reuse gates.",
      models: [{ id: "sonic-3.6", name: "Sonic 3.6 · Greg" }],
    },
    {
      id: "deepgram",
      name: "Deepgram Aura",
      ...
      note: "The exact Aura 2 Arcas stock route passed the native 24 kHz PCM streaming and terminal completion gates.",
      models: [{ id: "aura-2-arcas-en", name: "Aura 2 · Arcas" }],
    },
    {
      id: "inworld",
      name: "Inworld",
      ...
      note: "TTS 2 Flash with Dennis passed the native 24 kHz PCM stream and provider-viseme gates.",
      models: [
        {
          id: "inworld-tts-2-flash",
          name: "TTS 2 Flash · Dennis",
        },
      ],
    },
    {
...
const initialLoadouts: ProviderLoadout[] = [
  ...
  },
  {
    ...
    revision: 1,
    routes: {
      llm: { providerId: "groq", modelId: "openai/gpt-oss-20b" },
