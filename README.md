...
The current local-runtime decisions are recorded in the [Windows/NVIDIA AI runtime selection](docs/research/windows-nvidia-ai-runtime-selection-2026-08-30.md), the separate [Windows/NVIDIA local LLM runtime selection](docs/research/windows-nvidia-llm-runtime-selection-2026-08-30.md), the measured [real-time talking-face selection](docs/research/realtime-talking-face-selection-2026-09-01.md), the [2026 low-latency overhaul research](docs/research/realtime-lipsync-overhaul-2026-09-04.md), the [rejected first headless render](docs/research/headless-realistic-lipsync-proof-2026-09-03.md), the [rejected upper-lip-hole revision](docs/research/headless-realistic-lipsync-proof-2026-09-03-v2.md), and the [current full-contour proof](docs/research/headless-realistic-lipsync-proof-2026-09-04-v4.md). Stock MuseTalk is rejected from the resident gameplay path at 8.95 complete FPS and 7,617 MiB before a game. The active lightweight path uses pinned OpenSeeFace CPU landmarks, the complete 18-point mouth contour, sample-clocked provider visemes when available, and a pre-emphasized spectral PCM fallback otherwise. The current 960x720 candidate used the explicitly selected stock male NVIDIA Magpie voice Jason and measured 27.212 ms p95 moving tracking at adaptive 10 Hz, 2.634 ms p95 compositing at 30 FPS, 0 GPU VRAM, 32 changed adjacent source frames, 28 frames above its material mouth-motion gate, a 19.2% maximum articulated aperture relative to mouth width, and zero protected-upper-lip darkening. It locks the source upper lip and opens through a curved lower jaw. A conservative cavity, tongue tint, and gated upper-enamel reflection improve depth without claiming identity-correct reconstruction of unseen anatomy. It remains a causal talking-mouth renderer, not a neural full-head generator. Desktop broker presentation did not succeed in the last live attempt, so no local visual pack is selectable or release-ready.
