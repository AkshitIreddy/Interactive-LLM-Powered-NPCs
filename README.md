...
The current local-runtime decisions are recorded in the [Windows/NVIDIA AI runtime selection](docs/research/windows-nvidia-ai-runtime-selection-2026-08-30.md), the separate [Windows/NVIDIA local LLM runtime selection](docs/research/windows-nvidia-llm-runtime-selection-2026-08-30.md), the measured [real-time talking-face selection](docs/research/realtime-talking-face-selection-2026-09-01.md), the [rejected first headless render](docs/research/headless-realistic-lipsync-proof-2026-09-03.md), and its [source-preserving replacement](docs/research/headless-realistic-lipsync-proof-2026-09-03-v2.md). Stock MuseTalk is rejected from the resident gameplay path at 8.95 complete FPS and 7,617 MiB before a game. The active lightweight path uses pinned OpenSeeFace CPU landmarks plus an exact-frame procedural mouth residual. The replacement 960x720 run used the explicitly selected stock male NVIDIA Magpie voice Jason and measured 29.251 ms p95 tracking at adaptive 10 Hz, 1.337 ms p95 compositing at 30 FPS, 0 GPU VRAM, 32 changed adjacent source frames, and 27 frames above its material mouth-motion gate. It preserves source lip texture and does not synthesize teeth or tongue. It remains a causal talking-mouth renderer, not a neural full-head generator. Desktop broker presentation did not succeed in the last live attempt, so no local visual pack is selectable or release-ready.
